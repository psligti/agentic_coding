# OpenCode Python - Foundation Complete (Requires Dependency Installation)

OpenCode Python feature parity implementation - **Architecture Foundation Complete**
...
### Models (opencode_python/core/models.py)
...
### Storage (opencode_python/storage/store.py)
...
### Configuration (opencode_python/core/settings.py)
- **Pydantic Settings** with environment variable prefix `OPENCODE_PYTHON_`
...
### Agents (opencode_python/agents/builtin.py)
...
### File/Context Pipeline (opencode_python/context/pipeline.py)
...
### CLI (opencode_python/cli/main.py)
...
### TUI (opencode_python/tui/app.py)
...
# Use configuration
export OPENCODE_PYTHON_API_KEY=your-key
export OPENCODE_PYTHON_DEBUG=true
opencode run "Hello"
```
