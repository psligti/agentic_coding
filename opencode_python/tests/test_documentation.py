...
class TestGettingStartedDocumentation:
    ...
    def test_getting_started_has_code_examples(self) -> None:
        ...
        assert "from opencode_python.sdk import" in content, "Missing SDK imports in examples"
...
class TestExampleScriptsValidity:
    ...
    def test_examples_import_sdk(self) -> None:
        ...
        for example_path in examples:
            ...
            assert "from opencode_python.sdk import" in content or \
                   "import opencode_python.sdk" in content, \
